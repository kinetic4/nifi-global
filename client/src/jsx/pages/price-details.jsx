                  ...
                  <ul className="balance-widget">
                    <li>
                      <div className="icon-title">
                        ...
                        <span>
                          Bitcoin <br /> <small>Moves together</small>
                        </span>
                      </div>
                    ...
                    <li>
                      <div className="icon-title">
                        ...
                        <span>
                          Litecoin <br /> <small>Moves together</small>
                        </span>
                      </div>
                      <div className="text-right">
                        <h5>0.000242 USD</h5>
                    ...
                    <li>
                      <div className="icon-title">
                        ...
                        <span>
                          Ripple <br /> <small>Moves together</small>
                        </span>
                      </div>
                      <div className="text-right">
                        <h5>0.000242 USD</h5>
                    ...
                    <li>
                      <div className="icon-title">
                        ...
                        <span>
                          Dash <br /> <small>Moves together</small>
                        </span>
                      </div>
                      <div className="text-right">
                        <h5>0.000242 USD</h5>
                ...
                <div className="card-body">
                  <div className="invite-content">
                    ...
                    <p>
                      ...
                      Tasks <br /> <Link to={"#"}>Learn more</Link>
                    </p>
