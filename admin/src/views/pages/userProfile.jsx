                      ...
                      <Link to="#">
                        <svg width="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0)">
                            <path d="M341.269 85.0133H388.011V3.60533C379.947 2.496 352.213 0 319.915 0C252.523 0 206.357 42.3893 206.357 120.299V192H131.989V283.008H206.357V512H297.536V283.029H368.896L380.224 192.021H297.515V129.323C297.536 103.019 304.619 85.0133 341.269 85.0133Z" fill="#0165E1"></path>
                          </g>
                          <defs>
                            <clipPath id="clip0">
              ...
              <Col sm="4" lg="12">
                <Card className="card-block card-stretch card-height">
                  <Card.Body className="text-center">
                    ...
                    <h3 className="mb-2 mt-3 text-primary">42+</h3>
                    <h5>Awards</h5>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col sm="4" lg="12">
                <Card className="card-block card-stretch card-height">
                  <Card.Body className="text-center">
                    ...
                    <h3 className="mb-2 mt-3 text-warning">424+</h3>
                    <h5>Participated</h5>
                  </Card.Body>
                </Card>
              </Col>
            ...
            <Card className="card-block">
              ...
              <Card.Body>
                ...
                <ul className="list-unstyled mb-0">
                  <li className="mb-3"><svg xmlns="http://www.w3.org/2000/svg" className="text-primary me-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>{""} Lorem ipsum dolor sit amet,
                    consectetur adipiscing elit.</li>{""}
                  <li className="mb-3"><svg xmlns="http://www.w3.org/2000/svg" className="text-primary me-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>{""} Aliquam ultrices tellus in
                    auctor blandit.</li>{""}
                  <li className="mb-3"><svg xmlns="http://www.w3.org/2000/svg" className="text-primary me-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>{""} Etiam tincidunt erat non
                    ante sagittis bibendum.</li>{""}
                  <li className="mb-3"><svg xmlns="http://www.w3.org/2000/svg" className="text-primary me-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>{""} Nunc malesuada massa ut
                    nisl sollicitudin semper.</li>{""}
                  <li><svg xmlns="http://www.w3.org/2000/svg" className="text-primary me-2" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>{""} Fusce et arcu in dui feugiat finibus.
                  </li>{""}
                </ul>
                ...
                <div className="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <div className="iq-progress-bar pro-skill mt-2">
                    <span
                      data-percent="90"
                      style={{ transition: 'width 2s', width: '90%' }}
                    ></span>
                  </div>
                </div>
                <div className="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <div className="iq-progress-bar pro-skill mt-2">
                    <span data-percent="85" className="bg1" style={{ transition: 'width 2s', width: '85%' }}></span>
                  </div>
                </div>
                ...
                <div className="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <div className="iq-progress-bar pro-skill mt-2">
                    <span data-percent="65" className="bg-success" style={{ transition: 'width 2s', width: '65%' }}></span>
                  </div>
                </div>
                ...
                <div className="iq-progress-bar-linear d-inline-block w-100 mb-3">
                  ...
                  <div className="iq-progress-bar pro-skill mt-2">
                    <span data-percent="70" className="bg2" style={{ transition: 'width 2s', width: '70%' }}></span>
                  </div>
                </div>
                ...
                <div className="iq-progress-bar-linear d-inline-block w-100">
                  ...
                  <div className="iq-progress-bar pro-skill mt-2">
                    <span data-percent="55" className="bg3" style={{ transition: 'width 2s', width: '55%' }}></span>
                  </div>
                </div>
            ...
            <Card className="card-block">
              ...
              <Card.Body>
                <ul className="list-inline p-0 m-0">
                  ...
                  <li className="d-flex align-items-center mb-3">
                    <div className="profile-icon iq-icon-box rounded-small bg-primary-subtle text-center">
                  ...
                  <li className="d-flex align-items-center">
                    <div className="profile-icon iq-icon-box rounded-small bg-info-subtle text-center">
                      <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0)">
                          <path d="M0 8.39995V18.5999C0 18.9314 0.2685 19.1999 0.6 19.1999H3.6V7.19994H1.2C0.537375 7.19994 0 7.73732 0 8.39995ZM13.5 6.59994H12.6V5.09994C12.6 4.93419 12.4658 4.79994 12.3 4.79994H11.7C11.5343 4.79994 11.4 4.93419 11.4 5.09994V7.49994C11.4 7.66569 11.5343 7.79995 11.7 7.79995H13.5C13.6658 7.79995 13.8 7.66569 13.8 7.49994V6.89994C13.8 6.73419 13.6658 6.59994 13.5 6.59994ZM18.6656 4.20144L12.6656 0.201317C12.4685 0.0700041 12.2369 -6.10352e-05 12 -6.10352e-05C11.7631 -6.10352e-05 11.5315 0.0700041 11.3344 0.201317L5.33438 4.20144C5.17003 4.31101 5.03527 4.45945 4.94206 4.63358C4.84884 4.80772 4.80004 5.00218 4.8 5.19969V19.1999H9.6V13.7999C9.6 13.4684 9.8685 13.1999 10.2 13.1999H13.8C14.1315 13.1999 14.4 13.4684 14.4 13.7999V19.1999H19.2V5.20007C19.2 4.79882 18.9994 4.42382 18.6656 4.20144ZM12 9.59995C10.3433 9.59995 9 8.2567 9 6.59994C9 4.94319 10.3433 3.59994 12 3.59994C13.6568 3.59994 15 4.94319 15 6.59994C15 8.2567 13.6568 9.59995 12 9.59995ZM22.8 7.19994H20.4V19.1999H23.4C23.7315 19.1999 24 18.9314 24 18.5999V8.39995C24 7.73732 23.4626 7.19994 22.8 7.19994Z" fill="currentColor"></path>
                        </g>
