...
const BasicTable = () => {
  ...
  const table2 = [
    ...
    {
      class: "Primary",
      classname: "table-primary custom-white-color",
      heading1: "Cell",
      heading2: "Cell",
      heading1Class: "text-white",
      heading2Class: "text-white"
    },
    {
      class: "Secondary",
                ...
                <tbody>
                  {table2.map((item, idx) => (
                    <tr key={idx} className={`${item.classname}`}>
                      ...
                      <td className={`${item.heading1Class}`}>{item.heading1}</td>
                      <td className={`${item.heading2Class}`}>{item.heading2}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
