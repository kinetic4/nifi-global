        ...
        <Row>
          <Col lg={12}>
            <Card>
              <div className="card-header d-flex justify-content-between">
                <div className="header-title">
                  <h4 className="card-title">Datum Color</h4>
                </div>
              </div>
              <Card.Body>
                ...
                <Row className="mt-4">
                  ...
                  <div className="col-lg-2 col-md-6 text-center mb-4 mb-lg-0">
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Row className="mt-4">
                  <div className="col-lg-2 col-md-6 text-center mb-3 mb-md-0">
                  ...
                  <div className="col-lg-2 col-md-6 text-center mb-3 mb-md-0">
                    <p className="bg-dark-subtle text-gray pt-5 pb-5 text-center rounded font-size-18">Dark</p>
                  </div>
                  <div className="col-lg-2 col-md-6 text-center">
                    <p className="bg-gray-subtle pt-5 pb-5 text-center rounded font-size-18">Gray</p>
                  </div>
                </Row>
              </Card.Body>
            </Card>
          ...
          <Col lg={6}>
            <Card>
              <div className="card-header d-flex justify-content-between">
                <div className="header-title">
                  <h4 className="card-title">Datum Text Color</h4>
                </div>
              </div>
              <Card.Body>
                <p>
                ...
                <p className="text-black-50 bg-secondary">.text-black-50</p>
          ...
          <Col lg={6}>
            <Card>
              ...
              <Card.Body>
                ...
                <p className="bg-dark-subtle ps-3 pe-3 pt-2 pb-2 rounded text-gray">
                  Dark link
                </p>
                <p className="bg-gray-subtle ps-3 pe-3 pt-2 pb-2 rounded mb-0">Gray link</p>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={6}>
            <Card>
              ...
              <Card.Body>
                ...
                <p>
                  <Link
                    to="#"
                    className="bg-dark-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block text-gray"
                  >
                    Dark link
                  </Link>
                </p>
                <p className="mb-0">
                  <Link
                    to="#"
                    className="bg-gray-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block"
                  >
                    Gray link
                  </Link>
                </p>
