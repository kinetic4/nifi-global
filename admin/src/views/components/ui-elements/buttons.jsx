...
// react-bootstrap
import { Button, CardBody, Col, Dropdown, Row, Container } from "react-bootstrap";
          ...
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="outline-dark" className="mt-2 custom-dark-button">
                  Dark
                </Button>{" "}
              </Card.Body>
            </Card>
          ...
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="outline-dark" className="rounded-pill mt-2 custom-dark-button">
                  Dark
                </Button>{" "}
              </Card.Body>
            </Card>
          ...
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="dark-subtle" className="mb-1 text-white">Dark</Button>{" "}
              </Card.Body>
            </Card>
          </Col>
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="dark-subtle" className="rounded-pill mb-1 text-white">
                  Dark
                </Button>{" "}
              </Card.Body>
            </Card>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <svg width="15" height="16" class="me-2" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M12.7162 14.2236H5.49622" stroke="#2e46ba" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                     <path d="M12.7162 10.0371H5.49622" stroke="#2e46ba" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                     <path d="M8.25131 5.86035H5.49631" stroke="#2e46ba" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M12.9086 0.75C12.9086 0.75 5.23161 0.754 5.21961 0.754C2.45961 0.771 0.75061 2.587 0.75061 5.357V14.553C0.75061 17.337 2.47261 19.16 5.25661 19.16C5.25661 19.16 12.9326 19.157 12.9456 19.157C15.7056 19.14 17.4156 17.323 17.4156 14.553V5.357C17.4156 2.573 15.6926 0.75 12.9086 0.75Z" stroke="#2e46ba" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
                  Link
                </Button>{" "}
              </Card.Body>
          ...
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="outline-link text-primary" className="mt-2">
                  <svg
                    width="16"
                    height="15"
                    className="me-2"
          ...
          <Col sm="12" lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Button variant="outline-link text-primary" className="rounded-pill mt-2">
                  <svg
                    width="16"
                    height="15"
                    className="me-2"
              ...
              <Card.Body>
                ...
                >
                  ...
                  <div className="btn-group" role="group">
                    <Dropdown>
                      <Dropdown.Toggle variant="primary gap-1" id="dropdown-basic">
                        Dropdown
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="12"
