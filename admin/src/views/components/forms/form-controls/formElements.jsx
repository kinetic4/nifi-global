              ...
              <Form className="form-horizontal" action="/action_page.php">
                <Form.Group as={Row} className="form-group">
                  <Form.Label
                    column
                    sm="3"
                    className="control-label align-self-center mb-0 py-0"
                    htmlFor="email"
                  >
                    Email:
                  </Form.Label>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Form.Group className="form-group">
                ...
                <Form.Check className="d-block form-group mb-0">
                  <Form.Check.Input
                    className="me-2"
                    type="checkbox"
                    defaultValue=""
              ...
              <Form.Group className="form-group">
                ...
                <Form.Check className="form-radio">
                  <Form.Check.Input
                    ...
                    defaultChecked
                  />
                  <Form.Check.Label htmlFor="customRadio5" disabled>
                    {" "}
              ...
              <Form.Group>
                <div className="form-radio form-check mb-0">
                  <Form.Check.Input
                    type="radio"
                    id="customRadio8"
                    name="customRadio6"
