...
const Header = () => {
 const onClick = () => {
  ...
  const isDarkMode = document.querySelector("body").classList.contains("dark-theme");
                ...
                <Dropdown className="profile_log">
                  <Dropdown.Toggle>
                    <span className="thumb">
                      <img src='https://cdn-icons-png.flaticon.com/512/3135/3135715.png' alt="" width="30" />
                    </span>
                    ...
                    <div className="user-email">
                      <div className="user">
                        ...
                        <div className="user-info">
                          <h5>Username</h5>
                          <span>Nifi.Global@gmail.com</span>
                        </div>
                      </div>
                    </div>
