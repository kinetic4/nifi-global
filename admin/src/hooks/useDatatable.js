...
const useDataTable = ({
  ...
  useEffect(() => {
    setTimeout(() => {
      let datatableObj = {
        dom: '<"row align-items-center"<"col-md-6" l><"col-md-6" f>><"table-responsive" rt><"row justify-content-between" <"col-sm-12 col-md-5" i><"col-sm-12 col-md-7 " p>><"clear">',
        autoWidth: false,
        columns: columns,
        destroy: true,
      };
        ...
        datatableObj = {
          ...
          initComplete: function () {
            ...
            columns.forEach((column) => {
              ...
              if (column.data === null) {
                footerCell.innerHTML = column.title
              }
              else {
